...
//    public static final int HOUSE_NUM_PROPERTIES = 0;
    ...
    //abstract method called create that will apply to all of the subclasses.
    public abstract Entity create(EntityKind kind, String id, Point position, List<PImage> images, int resourceLimit, int resourceCount, double actionPeriod, double animationPeriod, int health, int healthLimit);
